...
class Log
  ...
  def main_menu
    ...
    loop do 
      ...
      when "store"
          log()
          pushup_entry(@total_pushups, @total_sets, @duration, @best)
  ...
  def pushup_entry(total_pushups, total_sets, duration, best)
    entry = Pushup.new(total_pushups, total_sets, duration, best)
    @pushups << Pushup.new(total_pushups, total_sets, duration, best)
